...
\checklist{审计师对特定会计处理有不同意见时出具保留意见}
...
\begin{explanation}
    \textbf{A选项错误。}
    \begin{itemize}
        \item 这个说法是正确的。当负债超过资产时，企业确实处于资不抵债状态。
    \end{itemize}
    
    \textbf{B选项正确。}
    \begin{itemize}
        \item 这个说法是错误的。实际上，银行破产（failures）相对较少，而银行资不抵债（insolvencies）则更为常见。这是因为银行即使资不抵债，只要仍能获得流动性支持，就可以继续运营。
    \end{itemize}
    
    \textbf{C选项错误。}
    \begin{itemize}
        \item 这个说法是正确的。破产是一个法律状态，与资不抵债不是同义词。资不抵债是破产的必要条件，但不是充分条件。
    \end{itemize}
...
\checklist{信用分析不包括评估借款人朋友和家人的财务状况}
...
\begin{explanation}
    ...
    \textbf{B选项正确。}
    \begin{itemize}
        \item 这个说法是错误的。实际上，银行破产（failures）相对较少，而银行资不抵债（insolvencies）则更为常见。这是因为银行即使资不抵债，只要仍能获得流动性支持，就可以继续运营。偿付能力衡量的是长期情况，而流动性看的是短期情况。
    \end{itemize}
...
\checklist{内部审计部门负责验证模型所有者是否遵守模型风险管理政策}
