...
\checklist{抵押贷款证券化的特征及其复杂性。（证券化产品的分层结构具有不同的风险水平）}
 ...
 \begin{question}
    ...
    在结构化金融讨论中，专家检查了抵押债务凭证（CDO）中不同档次的特征。哪一项陈述正确地描述了权益档次的特征？
\end{question}
...
\begin{choices}
    ...
    权益分层的投资者只有在其他层级获得支付后才能获得剩余现金流，并且在发生违约时首先承担损失。
    ...
    权益分层通过固定利率机制提供稳定的回报，对市场波动有适度的暴露。
    ...
    权益分层通过多样化底层资产保持一致的信用质量，导致可预测的现金流。
    ...
    权益分层通过其在瀑布支付结构中的高级地位提供增强的结构性保护。
\end{choices}
...
\begin{question}
    ...
    在典型的资产证券化交易中，抵押贷款池被分为三个档次：优先级档次、夹层档次和权益档次。优先级档次的投资者投资\$1,000,000，夹层档次的投资者投资\$500,000，权益档次的投资者投资\$500,000。如果抵押贷款池的总收入为\$1,800,000，并且出现\$200,000的违约损失，计算每个档次投资者的净收入。
    \end{question}
    
    \begin{choices}
    \item Senior Tranche: \$1,000,000; Mezzanine Tranche: \$250,000; Equity Tranche: \$0
    优先级分层：\$1,000,000；夹层分层：\$250,000；权益分层：\$0\\
    \item Senior Tranche: \$1,000,000; Mezzanine Tranche: \$200,000; Equity Tranche: \$100,000
    优先级分层：\$1,000,000；夹层分层：\$200,000；权益分层：\$100,000\\
    \item Senior Tranche: \$1,000,000; Mezzanine Tranche: \$0; Equity Tranche: \$100,000
    优先级分层：\$1,000,000；夹层分层：\$0；权益分层：\$100,000\\
    \item Senior Tranche: \$900,000; Mezzanine Tranche: \$100,000; Equity Tranche: \$0
    优先级分层：\$900,000；夹层分层：\$100,000；权益分层：\$0\\
    \end{choices}
