...
\begin{question}
    ...
    一位金融机构的风险分析师正在分类衍生品。哪一项关于将衍生品分类为线性或非线性的陈述是正确的？
    \end{question}
    ...
    \begin{choices}
        ...
        期权是线性衍生品，因为它们的回报与标的资产价值的变动直接成比例。
        ...
        远期和期货是非线性衍生品，因为它们的回报与标的资产价值的变动不成简单的线性关系。
...
\begin{question}
    ...
    一位投资银行的风险分析师正在评估各种市场参与者的动机。哪一方的主要目标是转移价格变动风险？
    \end{question}
    ...
    \begin{question}
        ...
        一位金融分析师正在分类不同类型的标的资产。哪一项正确地将资产分类为商品资产或金融资产？
        \end{question}
...
\begin{question}
    ...
    商品资产在衍生品市场中扮演重要角色，其独特特征影响交易策略和风险管理。一位风险分析师正在研究商品资产的特征，以更好地理解它们的行为及其对投资组合的影响。哪一项特征通常与商品资产相关？
    \end{question}
    ...
    \begin{question}
        ...
        一位金融机构的风险分析师正在评估不同的交易系统。哪一项陈述代表交易所交易系统的优势？
        \end{question}
...
\begin{question}
    ...
    一位大型银行的风险经理正在评估双边清算场外（OTC）衍生品交易的问题。哪一项陈述最不可能描述这些交易的问题？
    \end{question}
...
\begin{question}
    ...
    一位初级交易员在衍生品交易桌前试图理解不同衍生品的特点。哪一项陈述关于衍生品最不准确？
    \end{question}
    ...
    \begin{choices}
        ...
        互换是场外合同。与具有相同标的资产和到期日的交易所交易期权相比，互换的信用风险较低，因为严格监管。
        ...
        场外交易市场的优势是市场参与者可以根据自己的特定需求定制合约，而不是使用交易所定义的标准化合约。
        ...
        远期合约提供与期货合约类似的回报，但远期合约在OTC市场交易，而期货合约在交易所交易。
        ...
        衍生品市场吸引了各种交易者。投机者可以使用的高杠杆意味着交易者可以轻松承担重大风险。
    \end{choices}
...
\begin{question}
    ...
    \\一位初级交易员在衍生品交易桌前试图理解远期合约和期货合约的区别。这两种金融工具在金融世界中扮演重要角色，但它们具有显著差异，影响它们的交易动态、风险特征和监管环境。例如，它们的交易场所和合约标准化程度差异很大。哪一项陈述准确地捕捉了远期合约和期货合约之间的差异？
    \end{question}
    ...
    \begin{choices}
        ...
        远期合约在受监管的交易所公开上市和交易，遵守严格的合约规格标准化规范。
        ...
        期货合约受益于清算所的担保，有效地消除了交易中任何一方违约的风险。
        ...
        远期合约要求每日结算过程，其中盈利和亏损在每日基础上实现和核算。
    ...
    \begin{question}
        ...
        \\一家小型制造公司需要在六个月内签订一份购买特殊原材料的合同。该公司对质量、数量和交货条款有非常具体的要求，这些要求在市场标准中并不常见。对于这家公司来说，使用远期合约还是期货合约更合适，为什么？
        \end{question}
        
        \begin{choices}
            \item Futures contract, because it offers standardized terms that are easy to understand and trade.\\
            期货合约，因为它提供了易于理解和交易的标准化条款。
...
\begin{question}
    ...
    \\一位企业财务总监被要求对即将到来的六个月支付的外汇风险进行对冲。公司有相对较大的对冲成本预算，并希望在对其对冲策略保持灵活性。在进入远期合约和购买外汇期权之间，哪一种选择更合适，为什么？
    \end{question}
    
    \begin{choices}
        \item A forward contract, because it has no cost associated with it and provides a definite hedge.\\
        远期合约，因为它没有成本，并提供确定的对冲。
...
\begin{question}
    ...
    \\一位初级风险分析师正在研究期货、期权和远期的特性。哪一项关于这些衍生品工具的陈述是正确的？
    \end{question}
    ...
    \begin{choices}
        ...
        期货和远期都在交易所交易，而期权可以在交易所交易和场外交易（OTC）。
        ...
        在期货和远期中，交易双方的权利和义务是对称的，而在期权中，多头和空头的权利和义务是不对称的。
...
\begin{question}
    ...
    \\一位金融分析师正在比较场外交易（OTC）和交易所交易衍生品的特点。哪一项陈述准确地反映了这两种交易环境之间的差异？
    \end{question}
    ...
    \begin{choices}
        ...
        场外衍生品是标准化合约，而交易所交易衍生品可以根据特定需求定制。
    ...
    \begin{question}
        ...
        \\一位投资者进入4份多头期货合约，以每盎司\$20的价格购买八月份白银。白银期货合约规模为100金衡盎司。初始保证金为每份合约\$200，维持保证金为初始保证金的80\%。哪一项关于期货价格下降会导致追加保证金通知的陈述是正确的？
        \end{question}
...
\begin{question}
    ...
    \\一位对冲基金经理旨在将管理资产中的现金部分进行证券化。他进入了一个股票指数的长期期货头寸，乘数为300。现金头寸为\$9,000,000，当前期货价值为1200，要求经理持有25份合约。如果当前初始保证金为每份合约\$18,000，当前维持保证金为每份合约\$15,000，如果期货合约价值在头寸的第一天结束时下降到1185，则投资组合经理需要追加的变动保证金是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位金融分析师正在比较普通会计准则和对冲会计对期货合约的处理。哪一项陈述准确地描述了这两种会计方法之间的差异？
    \end{question}
    ...
    \begin{choices}
        ...
        普通会计准则下，期货合约损益是在会计期末确认，导致账面收益稳定。相比之下，对冲会计要求立即确认损益，增加收益波动性。
        ...
        普通会计准则要求期货损益发生时入账，导致账面收益波动性大。对冲会计可以降低这种波动性，但认定标准严格。
        ...
        普通会计准则和对冲会计以相同方式确认期货合约损益，收益波动性没有显著差异。
        ...
        对冲会计允许无限期递延期货合约所有损益，普通会计准则仅在合约平仓时确认损益。
    \end{choices}
    ...
    \begin{question}
        ...
        \\一位投资组合经理旨在利用管理资产中的现金部分。经理进入了一个纳斯达克100指数的长期期货头寸，乘数为300。现金头寸为\$20,000,000，当前期货价值为1200，要求经理持有55份合约。如果当前初始保证金为每份合约\$15,000，当前维持保证金为每份合约\$12,000，如果期货合约价值在头寸的第一天结束时下降到1196，则投资组合经理需要追加的变动保证金是多少？
        \end{question}
...
\begin{question}
    ...
    \\一位投资者进入8份多头期货合约，以每盎司\$20的价格购买九月份白银。白银期货合约规模为50金衡盎司。初始保证金为每份合约\$5,000，维持保证金为初始保证金的80\%。哪一项关于白银期货价格下降会导致追加保证金通知的陈述是正确的？
    \end{question}
    ...
    \begin{question}
        ...
        \\七月，一位名叫Sarah的投资者购买了三份九月铂金期货合约。每份合约规模为4,000盎司铂金，购买时的期货价格为每盎司\$20.50。所需的初始保证金为\$7,000，维持保证金为\$5,500。以下是九月铂金期货的价格历史：
        \begin{center}
            \begin{tabular}{|c|c|c|}
            \hline
            日期 & 期货价格 & 每日盈亏 \\ \hline
        ...
        \begin{choices}
            \item July 5 only\\只有7月5日
            \item July 4 and July 5 only\\7月4日和7月5日
            \item July 5 and July 10 only\\7月5日和7月10日
            \item July 4, July 5 and July 11 only\\7月4日、7月5日和7月11日
        \end{choices}
...
\begin{question}
    ...
    \\一位投资者持有股票的多头头寸，当前市场价格为\$40。投资者有两个目标。首先，只要股票价格继续上涨，就保持所有权。其次，如果股票价格跌破\$35，则完全平仓。哪一种指令最能实现这两个目标？
    \end{question}
...
\begin{question}
    ...
    \\一位投资者持有300,000盎司白银。为了对冲价格风险，投资者卖出300份白银期货合约。初始期货价格为每盎司\$25。如果期货价格在到期时上升到\$28，则期货头寸的盈亏是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位农民种植小麦，希望对即将到来的收获价格风险进行对冲。小麦现货价格和期货价格的相关系数为0.7，小麦现货价格的标准差为0.04，小麦期货价格的标准差为0.0625。农民如何最小化价格风险，最优对冲比例是多少？
    \end{question}
    ...
    \begin{question}
        ...
        \\一位投资者持有价值\$1,750,000的多元化股票组合。该组合的回报率标准差为\$0.25，S\&P 500指数期货回报率标准差为\$0.15，组合回报率与S\&P 500指数期货回报率的相关系数为\$0.9。S\&P 500指数期货合约乘数为\$250，当前S\&P 500指数水平为\$3,500。投资者应采取哪一项行动来对冲股票组合的价格风险？
        \end{question}
...
\begin{question}
    ...
    \\一位投资经理管理着一个价值1500万美元的投资组合，其相对于S\&P 500指数的beta为0.6。当前S\&P 500指数水平为3,000，3个月后到期的S\&P 500指数期货，合约乘数为S\&P 500指数价值×250，交易价格为3,050。为了将投资组合的beta提高到1.4，哪一项交易行动是正确的？
    \end{question}
...
\begin{question}
    ...
    \\一位风险经理正在分析期货合约对冲中的基差风险概念。哪一项关于基差风险的陈述是正确的？
    \end{question}
    ...
    \begin{choices}
        ...
        基差风险仅存在于被对冲资产与期货合约标的资产完全相同且持有至到期的情况，且对冲持有至到期。
        ...
        基差风险源于平仓时基差的不确定性，主要由时间不匹配（如套期保值期限与期货合约期限不一致）和资产不匹配（如用于套期保值的期货标的资产与现货资产不完全相同 ）导致。
        ...
        基差通常定义为期货价格减去现货价格，基差风险仅与这种关系稳定性有关。
    \end{choices}
...
\begin{question}
    ...
    \begin{choices}
        ...
        在滚动对冲策略中，交易员在交割期开始时立即平仓短期期货对冲头寸，并替换为长期期货对冲头寸。
        ...
        滚动对冲策略需要实施短期期货对冲，在交割期前平仓，并用另一个短期期货对冲替换，如此反复。
...
\begin{question}
    ...
    \begin{choices}
        ...
        基差风险仅在交叉对冲策略中出现，当被对冲资产和标的资产相同时，基差风险消失。对于空头对冲头寸，基差意外走弱会带来收益。
        ...
        基差风险仅在交叉对冲策略中出现，当被对冲资产和标的资产相同时，基差风险消失。对于多头对冲头寸，基差意外走强会带来收益。
        ...
        基差风险仅在交叉对冲策略中出现，当被对冲资产和标的资产相同时，基差风险消失。对于空头对冲头寸，基差意外走强会带来收益。
        ...
        基差风险在交叉对冲策略中会出现，当套期保值资产和标的资产相同时，基差风险消失。
    \end{choices}
...
\begin{question}
    ...
    \\一位商品交易员在交易公司分析小麦期货的基差。2023年7月的现货价格(\(S_1\))为每蒲式耳\$6.40，2024年3月的期货价格(\(F_1\))为\$8.50。四个月后，在11月，假设小麦的现货价格(\(S_2\))增加到\$6.80，2024年3月的期货价格(\(F_2\))增加到\$8.60。七月和十一月之间的基差发生了什么变化？
    \end{question}
...
\begin{question}
    ...
    \\一位羊农担心他可以获得的羊羔价格低于他的预期。为了保护自己免受羊羔价格下降的风险，农民选择使用活羊期货进行对冲。他已采取适当数量的羊期货头寸，用于11月交割，他认为这将平衡春季销售季节羊羔价格下降的影响。合适的头寸和可能的基差风险来源分别是什么？
    \end{question}
...
\begin{question}
    ...
    \end{tabular}
    \end{center}
    你打算使用期货对冲钛投资。然而，没有基于这种资产的期货合约。为了找到最合适的期货合约进行对冲，你进行了钛价格变动与相似资产价格变动的回归分析。根据以下回归结果，哪一项资产关联的期货合约最有可能引入最小的基差风险到你的对冲头寸？
    \begin{center}
        \begin{tabular}{|c|c|c|c|}
        \hline
        \multicolumn{4}{|c|}{钛价格变动 = $\alpha+\beta$（资产价格变动）} \\ \hline
        资产 & $\alpha$ & $\beta$ & $R^{2}$ \\ \hline
        A & 1.50 & 1.10 & 0.70 \\ \hline
        B & 0.80 & 1.60 & 0.85 \\ \hline
        C & 0.05 & 0.90 & 0.30 \\ \hline
        D & 5.00 & 2.50 & 0.50 \\ \hline
...
\begin{question}
    ...
    \\苹果公司是一家依赖从泰国采购大量橡胶组件的公司。苹果打算对未来8个月的橡胶价格波动进行对冲。不幸的是，橡胶期货合约不容易获得。通过研究，苹果发现其他商品的期货合约与橡胶价格密切相关。Commodity X的期货价格与橡胶价格的相关系数为0.88，Commodity Y的期货价格与橡胶价格的相关系数为0.95。Commodity X和Commodity Y的期货合约都有7个月和10个月到期。忽略流动性因素，哪一份合约最有可能最小化基差风险？
    \end{question}
    
    \begin{choices}
        \item Futures on Commodity X with 7 months to expiration\\
        7个月到期的Commodity X期货合约
        \item Futures on Commodity X with 10 months to expiration\\
        10个月到期的Commodity X期货合约
        \item Futures on Commodity Y with 7 months to expiration\\
        7个月到期的Commodity Y期货合约
        \item Futures on Commodity Y with 10 months to expiration\\
        10个月到期的Commodity Y期货合约
    \end{choices}
...
\begin{question}
    ...
    \\一位商品交易公司的风险分析师正在评估一个投资组合的最优对冲比例。铜期货价格变动的标准差为0.4，铜现货价格变动的标准差为0.5，现货价格变动与期货价格变动的协方差为0.26。哪一项最接近最优对冲比例？
    \end{question}
    ...
    \begin{question}
        ...
        \\一位制造公司的风险经理正在评估一个投资组合的最优对冲比例。商品季度价格变动的标准差为0.65，商品期货季度价格变动的标准差为0.92，两个价格变动的相关系数为0.4215。3个月合约的最优对冲比例是多少？
        \end{question}
...
\begin{question}
    ...
    \\12月1日，Lisa Thompson，一个价值8000万美元的美国中型至大型股票投资组合的基金经理，想要锁定最近市场上涨的利润。S\&P 500指数和其期货合约的乘数为200，交易价格分别为1050和1060。她决定不平仓，而是对未来3个月的市场风险敞口进行三分之四的对冲。已知Lisa的投资组合与S\&P 500指数期货的相关系数为0.92，股票基金和期货的年波动率分别为0.55和0.52。为了实现她的目标，她应该采取什么头寸？
    \end{question}
    ...
    \begin{question}
        ...
        \\当前纳斯达克100指数期货价值为1320，每个纳斯达克100指数期货合约的价值为纳斯达克100指数价值的100倍。一个市值为2.5亿美元的长仓股票投资组合的贝塔值为1.2。为了将投资组合贝塔值降低到0.8，应该卖出多少份纳斯达克100指数期货合约？
        \end{question}
...
\begin{question}
    ...
    \\一位金融衍生品交易员刚刚与一位客户签订了一份6年期的固定利率支付交换（久期4.65），与另一位客户签订了一份12年期的固定利率接收交换（久期8.2）。已知6年期利率为4.3\%，12年期利率为5.6\%，所有合约均按面值交易。交易员如何对冲其头寸？
    \end{question}
...
\begin{question}
    ...
    \\一家铝生产商将在四个月后以当前市场价格出售1,200吨铝。铝价格四个月变动的标准差为2.8\%。公司决定使用锌期货对冲价格风险。锌期货合约规模为20吨锌。锌期货价格变动的标准差为3.5\%。锌期货价格变动与铝价格变动的相关系数为0.80。为了对冲价格风险，公司应该买入/卖出多少份期货合约？
    \end{question}
...
\begin{question}
    ...
    \\你是一位管理着一个价值2.5亿美元的增长型投资组合的基金经理，该投资组合相对于纳斯达克100指数的贝塔值为1.3。纳斯达克100指数期货交易价格为13,500，乘数为100。你想在未来几个月对冲市场风险。确定是多头套期保值还是空头套期保值合适，并确定需要卖出多少份纳斯达克100指数期货合约来实施套期保值。
    \end{question}
...
\begin{question}
    ...
    \\一个价值1.2亿美元的股票投资组合的基准是S\&P 500指数。S\&P 500指数当前为4,000，相应的投资组合贝塔值为1.1。S\&P 500指数期货的乘数为250。哪一项最接近需要卖出多少份期货合约来将投资组合贝塔值提高到3倍？
    \end{question}
...
\begin{question}
    ...
    \\一个价值8000万美元的股票投资组合的基准是纳斯达克100指数。纳斯达克100指数当前为15,000，相应的投资组合贝塔值为1.5。纳斯达克100指数期货的乘数为100。要将贝塔值降低到当前值的三分之一，哪一项交易是正确的？
    \end{question}
...
\begin{question}
    ...
    \\一位能源交易公司的财务经理正在研究与对冲操作相关的会计法规。经理正在评估采用标准会计或对冲会计的应用和后果，以及对冲活动的税收影响。哪一项关于对冲交易会计处理的陈述是正确的？
    \end{question}
    
\begin{choices}
    \item Under hedge accounting, the gain or loss on a hedge is recognized at the same time as the item being hedged.\\
    在对冲会计中，对冲的全部收益或损失是在同一时间实现的。
...
A natural gas producer has a contractual obligation to supply 50,000 cubic feet of natural gas every month for two years at a fixed price. The producer wants to hedge against potential upward spikes in natural gas prices and chooses a stack and roll hedge over a strip hedge. Which of the following statements is correct?
    \\一位天然气生产商有一个固定价格供应50,000立方英尺天然气的合同。生产商希望对冲天然气价格上涨的潜在风险，选择堆叠滚动套期保值而不是条式套期保值。哪一项陈述是正确的？
\end{question}
...
\begin{choices}
    ...
    条式套期保值由于每月最小化交易，降低了交易成本，并且与堆叠滚动套期保值相比，买卖价差更窄。
    ...
    条式套期保值由于每月频繁交易，增加了交易成本，并且与堆叠滚动套期保值相比，买卖价差更宽。
    ...
    堆叠滚动套期保值由于每年滚动合约，增加了交易成本，并且与条式套期保值相比，买卖价差更宽。
    ...
    堆叠滚动套期保值由于只需要每季度交易，降低了交易成本，并且与条式套期保值相比，买卖价差更窄。
\end{choices}
...
\begin{question}
    ...
    \\一位石油生产商正在考虑一个对冲策略。当前石油现货价格为\$112，一个月后到期的石油期货价格为\$108，12个月后到期的石油期货价格为\$104。如果一年内石油现货价格和石油期货价格曲线保持完全不变，且生产商使用堆叠滚动套期保值方法（例如，一年后，石油现货价格仍为\$112），滚动对冲的净表现是多少，忽略未来石油现货销售的期货对冲，忽略交易成本？
    \end{question}
    ...
    \begin{question}
        ...
        \\ 一位矿业公司的分析师正在评估对公司锌产量进行4年期套期保值的潜在现金流和会计影响。该套期保值通过在2023年12月31日以每磅锌2.50美元的价格卖出80份4年期期货合约建立，每份合约代表20,000磅锌。该分析师有以下数据：
        \begin{center}
        \begin{tabular}{|c|c|}
        \hline
        日期 & 期货价格（美元） \\ \hline
        ...
        \end{tabular}
        \end{center}
        该公司采用套期会计，并在每个日历年末报告由套期保值变动保证金产生的现金流。以下哪一项是对2025年12月31日报告的现金流的最佳估计？
        \end{question}
...
\begin{question}
    ...
    \\假设有一年期外汇远期和期货合约，报价价格均为1.2500 GBPUSD。一年内，期货价格先下降到1.1500 GBPUSD，然后上升到1.3500 GBPUSD。一年内利率保持不变。对于想要买入150万英镑并消除汇率风险的交易者，考虑期货合约的逐日盯市效应，哪一项是更有利的选择？
    \end{question}
...
\begin{question}
    ...
    一位商品交易员正在分析特定资产期货合约的市场条件。哪一项陈述正确区分了期货价格正常市场和反向市场？
    \end{question}
    ...
    \begin{choices}
        ...
        在正常市场中，期货价格随到期时间增加而下降，而在反向市场中，期货价格随到期时间增加而上升。
        ...
        正常市场是近月期货价格高于远月期货价格，而在反向市场中，远月期货价格高于近月期货价格。
        ...
        在正常市场中，期货价格随到期时间增加而上升，而在反向市场中，期货价格随到期时间增加而下降。
        ...
        \item Both normal and inverted markets have the same pattern of futures price movement with respect to time to maturity, but they differ in other aspects such as trading volume.\\
        正常市场和反向市场在期货价格随到期时间变动模式上相同，但在其他方面不同，如交易量。
    \end{choices}
    ...
    \begin{question}
        ...
        \\一位商品交易员正在分析商品Y的远期市场。商品Y的当前现货价格为\$38.50。一年期的商品Y远期合约交易价格为\$39.35。已知当前年化无风险利率为6.5\%，交易员需要计算商品Y的隐含租赁利率。然后，假设计算出的隐含租赁利率保持不变，交易员需要确定如果年化无风险利率突然下降到4.5\%，商品Y的远期市场是处于反向市场还是期货溢价市场。
        \end{question}
        ...
        \begin{choices}
            ...
            隐含租赁利率为2.24\%。保持此利率不变，如果年化无风险利率立即下降到4.5\%，远期市场将处于期货溢价市场。
            ...
            隐含租赁利率为4.29\%。保持此利率不变，如果年化无风险利率立即下降到4.5\%，远期市场将处于反向市场。
            ...
            隐含租赁利率为2.24\%。保持此利率不变，如果年化无风险利率立即下降到4.5\%，远期市场将处于反向市场。
            ...
            隐含租赁利率为4.29\%。保持此利率不变，如果年化无风险利率立即下降到4.5\%，远期市场将处于期货溢价市场。
        \end{choices}
...
\begin{question}
    ...
    在商品市场中，现货价格和远期价格的关系由商品价格曲线描绘。哪一项陈述是正确的？
    \end{question}
    ...
    \begin{choices}
        ...
        在期货溢价市场中，远期价格高于现货价格，代表商品供应商的正向收益。
        ...
        在反向市场中，现货价格高于远期价格，代表商品消费者的正向收益。
        ...
        在期货溢价市场中，现货价格高于远期价格，代表商品消费者的正向收益。
        ...
        在反向市场中，远期价格高于现货价格，代表商品供应商的正向收益。
    \end{choices}
    ...
    \begin{question}
        ...
        \begin{choices}
            ...
            作为反向期货市场，因为远期交割合约的交易价格低于近期交割合约。
...
\begin{question}
    ...
    \\一位风险分析师正在分析各种因素变化对资产远期价格的影响。假设所有其他因素保持不变，当资产的离散复利租赁率($q$)增加时，远期价格($F$)会如何变化？
    \end{question}
...
\begin{question}
    ...
    \\一位权益对冲基金的风险分析师正在估计3个月后到期的纳斯达克100指数期货合约的价格。分析师有以下市场数据：
    \begin{itemize}
    \item 当前纳斯达克100指数水平：USD 12,500
    \item 无风险利率：2.2\% per year
    \item 股息收益率：1.6\% per year
    \end{itemize}
    哪一项值最接近3个月后到期的纳斯达克100指数期货合约的价格？
    \end{question}
...
\begin{question}
    ...
    \\一位商品交易员正在比较商品期货和金融期货的定价。哪一项是商品期货和金融期货之间最重要的区别？
    \end{question}
    ...
    \begin{question}
        ...
        \\一位投资公司的风险分析师被要求计算一个大宗商品期货合约的连续复利定价。当前大宗商品现货价格为USD 800。无风险利率为3\% per annum，储存成本为2\% per annum，便利性收益为1.5\% per annum。合约到期时间为9个月。该大宗商品期货合约的价格是多少？
        \end{question}
...
\\一个股票指数价值为USD 800，股息率为2.5\% per annum。该指数的9个月期货合约交易价格为USD 820。无风险利率为4\% annually compounded。没有交易成本或税费。期货合约是否定价使得存在套利机会？如果是，哪一项数值最接近通过持有一份期货合约可以实现的套利利润？
\end{question}
...
\begin{question}
    ...
    一位投资银行的风险分析师正在寻找套利机会。一项资产目前交易价格为USD 1,100。该资产的一年期期货合约交易价格为USD 1,115，两年期期货合约交易价格为USD 1,135。假设该资产在两年内没有现金流。如果利率期限结构为1.2\% per year (annually compounded)，哪一项是合适的套利策略？
    \end{question}
    
    \begin{choices}
        \item Short 1 - year futures and long the underlying asset funded by borrowing for 1 year\\
        空头一年期期货合约并多头底层资产，通过一年期借款融资。
    ...
    \begin{question}
        ...
        \\一位金融顾问正在帮助客户选择在交易所进行的期货合约与与对手方签订的远期合约。两份合约具有相同的到期时间和交割条款。顾问注意到期货价格低于远期价格。假设没有套利机会，哪一项单独因素可能合理解释这一价格差异？
        \end{question}
...
\begin{question}
    ...
    \begin{question}
        ...
        \\一位贵金属投资公司的风险分析师正在评估不同贵金属的供需动态以及白银远期价格的中期波动。目前，白银现货价格为USD 22.10 per troy ounce，八个月远期价格为USD 22.30 per troy ounce。假设八个月后，租赁利率高于连续复利利率。哪一项陈述关于八个月后白银远期曲线的形状是正确的？
        \end{question}
...
\begin{question}
    ...
    一位金融公司的初级分析师正在研究期货市场和其底层现货市场之间的关系。分析师旨在理解这两个市场价格变动的相互作用，并基于这些关系提出交易策略。哪一项陈述关于期货价格和现货价格是正确的？
    \end{question}
    ...
    \begin{choices}
        ...
        如果期货价格在交割期内低于标的资产现货价格，交易者可以通过在现货市场卖出期货合约并买入底层资产来获利。
...
\begin{question}
    ...
    \begin{question}
        ...
        \\一位黄金交易公司的风险经理在四个月前签订了一份一年期黄金远期合约，购买100盎司黄金。当时的一年期黄金远期价格为USD 980 per ounce。现在八个月后的黄金远期价格为USD 1030 per ounce。无风险利率为3.5\% per annum，没有存储成本。哪一项最接近合约的价值？
        \end{question}
...
\begin{question}
    ...
    \\一位法国银行的外汇交易员签订了一份5个月后卖出3500万英镑的远期合约，汇率EUR 0.78 per GBP。如果5个月后汇率变为EUR 0.83 per GBP，银行从远期合约中获得的收益是多少？
    \end{question}
    ...
    \begin{question}
        ...
        一位美国公司的财务分析师正在处理一个净贸易应收情况。2010年5月1日，公司从法国公司的一项出口合同中收到净贸易应收EUR 6,000,000。公司预计在2010年11月1日收到这笔款项。ABC公司的首席财务官想要保护这笔应收的价值。2010年5月1日，EUR即期汇率为1.36，六个月EUR远期汇率为1.35。首席财务官有两个选择：通过签订远期合约锁定汇率或卖出六个月EUR 6,000,000看涨期权，执行价格为1.36。首席财务官认为卖出期权优于签订远期合约，因为如果EUR升值，ABC可以按1.36的汇率收到USD，这比1.35的远期汇率更好。如果EUR贬值，期权不会被行使，ABC可以保留卖出期权获得的期权费。哪一项关于首席财务官的分析是正确的？
        \end{question}
        
        \begin{choices}
            \item CFO's analysis is not correct. The company will suffer if the EUR goes up sharply.\\
            CFO的分析不正确，如果EUR大幅升值，公司会遭受损失。
            \item CFO's analysis is correct. The company is better off whichever way the EUR rate goes.\\
            CFO的分析正确，无论EUR汇率如何变动，公司都更有利。
            \item CFO's analysis is not correct. The company will suffer if the EUR moves within a narrow range.\\
            CFO的分析不正确，如果EUR汇率在窄幅波动范围内变动，公司会遭受损失。
            \item CFO's analysis is not correct. The company will suffer if the EUR goes down sharply.\\
            CFO的分析不正确，如果EUR大幅贬值，公司会遭受损失。
        \end{choices}
...
\begin{question}
    ...
    \begin{choices}
        ...
        做多石油远期合约，做空石油现货，并将多余资金按无风险利率借出。
    \end{choices}
    ...
    \begin{question}
        ...
        \\哪一项数值最接近四个月后的小麦远期价格，如果当前小麦现货价格为\$4 per bushel，有效月利率为1.2\%，每月存储成本为\$0.04 per bushel？假设未来四个月的存储成本现值为\$0.15 per bushel。
        \end{question}
...
\begin{question}
    ...
    \\一位资产管理公司的风险经理正在对股票ABC的三年期远期合约进行情景分析，考虑利率可能的变化。经理有以下数据：
    \begin{itemize}
    \item 股票ABC的当前价格：USD 80.50
    \item 无风险利率：-0.50\% per annum
    \item 股票ABC的股息率：0.50\% per annum
    \end{itemize}
    假设远期合约目前定价合理，所有股息都 reinvested into stock ABC，如果无风险利率立即增加1.2\%，哪一项数值最接近股票ABC远期合约价值的变动（每份ABC股票）？
    \end{question}
...
\begin{question}
    ...
    \\一位金融公司的初级分析师正在研究期权和远期衍生品合约的特点。在分析线性和非线性衍生品合约的区别时，哪一项陈述最可能准确地被分析师得出？
    \end{question}
    ...
    \begin{choices}
        ...
        远期合约是线性衍生品，一方有义务按预先设定价格支付，另一方有义务交付标的资产。
