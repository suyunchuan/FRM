...
\begin{question}
    ...
    一位概率论教授正在向一群研究生讲授基本概念。教授强调随机变量、结果、事件和事件空间是概率论的基本概念。哪一项关于这些概念的陈述是正确的？
    \end{question}
    ...
    \begin{question}
        ...
        一位全球投资银行的风险经理正在与其团队讨论概率论的基本原则。在讨论风险评估方法时，他强调这些概率原则对于量化市场风险和做出投资决策至关重要。哪一项关于概率基本原则的陈述不符合概率的基本原则？
    \end{question}
        ...
        \begin{question}
            ...
            一位投资银行的对冲基金经理正在评估其交易组合中信用违约事件和市场波动飙升之间的相关性。为了更好地理解风险依赖性，他正在与其团队讨论概率论的基本概念。哪一项关于互斥事件和独立事件的陈述是正确的？
        \end{question}
        
        \begin{choices}
            \item The joint probability of mutually exclusive events equals zero, as these events cannot occur simultaneously.\\
            互斥事件的联合概率等于0，因为这些事件不能同时发生。
...
\begin{question}
    ...
    一位对冲基金的风险分析师正在研究市场风险事件与信用风险事件之间的关系。该分析师收集了以下概率数据。给定事件A和B，以及条件事件C：
    \begin{itemize}
        \item \(P(A) = 40\%\), \(P(B) = 40\%\), \(P(A \cap B) = 16\%\)
        \item \(P(A|C) = 50\%\), \(P(B|C) = 50\%\), \(P(A \cap B|C) = 25\%\)
    \end{itemize}
    
    哪一项关于无条件独立性和条件独立性的陈述是不正确的？
\end{question}
...
\begin{question}
    ...
    一位投资公司的金融分析师正在研究两个与市场运动相关的事件A和B。事件A发生的概率与事件B发生的概率相同。事件A和B同时发生的概率为\(P(AB)=5\%\)。给定事件A已经发生，事件B发生的概率为\(70\%\)。事件A和事件B都不发生的概率是多少？
    \end{question}
...
\begin{question}
    ...
    一位国家储蓄的初级抵押分析师正在评估Tom和Kathy的抵押申请。在正常情况下，银行对借款人的贷款决策是相互独立的，但在经济衰退时则不是。在正常情况下，Tom有75\%的概率获得抵押贷款，Kathy有85\%的概率获得抵押贷款。在经济衰退时，Tom的概率降至25\%，Kathy的概率降至30\%。Tom做出了以下陈述。哪一项陈述是正确的？
    \end{question}
    
    \begin{choices}
        \item There is a probability of 63.75\% that both of them could get mortgages from the bank generally.\\
        他们从银行获得抵押贷款的概率为63.75\%。
...
\begin{question}
    ...
    一位固定收益投资公司的风险分析师正在评估Bond X和Bond Y。这两只债券具有相同的评级和违约概率。预计两只债券在未来一年内违约的概率为8\%。如果Bond X明年违约，则Bond Y明年违约的概率为40\%。明年Bond X和Bond Y都不违约的概率是多少？
    \end{question}
...
一位全球投资银行的风险分析师正在研究两个市场事件之间的相关性。分析师已经确定：
\begin{itemize}
    \item 事件A发生的概率为50\%
    \item 事件B发生的概率为70\%
    \item 事件A或事件B发生的概率为85\%
\end{itemize}
哪一项关于这些事件的陈述是正确的？
\end{question}
...
一位金融咨询公司的风险分析师正在审查全概率定理的应用。全概率定理是条件概率中的一个重要概念，指出在给定条件集的概率之和等于1的情况下，事件的总概率可以通过条件概率重建。哪一项关于全概率定理的陈述正确地应用了全概率定理？
\end{question}
...
\begin{question}
    ...
    一位投资银行的金融分析师正在研究关于经济状况和市场的概率分布。该分析师已得出以下数据：
    \begin{center}
    \begin{tabular}{|c|c|}
    \hline
    初始概率 \(P(A)\) & 条件概率 \(P(B|A)\) \\
    \hline
    良好经济 70\% & \begin{tabular}{c}牛市 40\% \\ 正常市场 35\% \\ 熊市 25\%\end{tabular} \\
    \hline
    疲软经济 30\% & \begin{tabular}{c}牛市 15\% \\ 正常市场 25\% \\ 熊市 60\%\end{tabular} \\
    \hline
    \end{tabular}
    \end{center}
    下列关于该概率分布的陈述中，哪一项最不可能准确？\\
    \end{question}
...
\begin{question}
    ...
    一位投资者在国家Y通过邮政系统与商业伙伴通信。国家Y的邮政系统中，一封信到达目的地的概率为3/4。假设每个邮政投递是独立的，并且假设如果商业伙伴收到投资者的信，商业伙伴一定会回复。假设投资者给商业伙伴发送了一封信。如果投资者没有收到商业伙伴的回复信，那么商业伙伴收到他的信的概率是多少？
    \end{question}
...
\begin{question}
    ...
    一位保险公司的精算师正在分析保单持有人的续保概率。精算师估计，只有汽车保险的客户中有30\%会续保明年，只有房屋保险的客户中有70\%会续保明年。同时，同时拥有汽车和房屋保险的客户中有90\%会续保至少其中一种保险明年。公司记录显示，70\%的客户拥有汽车保险，40\%的客户拥有房屋保险，10\%的客户同时拥有汽车和房屋保险。使用公司的估计，明年至少续保一种保险的客户比例是多少？
    \end{question}
...
一位初级抵押分析师正在研究一个由1200个次级抵押贷款和800个优质抵押贷款组成的组合。在次级抵押贷款中，有240个逾期还款。在优质抵押贷款中，有64个逾期还款。如果分析师随机从组合中选中一个抵押贷款，发现它目前逾期还款，那么它是次级抵押贷款的概率是多少？
\end{question}
...
\begin{question}
    ...
    一位初级抵押分析师正在研究一个由次级无担保贷款组成的组合。分析师发现，15\%的贷款逾期还款。在逾期还款的贷款中，70\%的贷款未偿还余额超过借款人预计未来收入的价值，作为还款的参考。在非逾期还款的贷款中，20\%的贷款未偿还余额大于预计未来收入。如果分析师随机从组合中选中一个贷款，发现其预计未来收入小于未偿还余额，那么它是逾期还款贷款的概率是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位投资公司的风险分析师正在评估由金融机构发行的特定年金债券的一年期违约概率是否与股票市场收益不相关。该分析师基于初步研究的一年期概率创建了以下联合概率矩阵：
    \begin{center}
    \begin{tabular}{|c|c|c|}
    \hline
    \multirow{2}{*}{股票市场收益}& \multicolumn{2}{c|}{年金债券} \\
    \cline{2 - 3}
     & 不违约 & 违约 \\
    \hline
    上涨30\% & 58\% & 2\% \\
    ...
    \end{tabular}
    \end{center}
    如果市场在一年内下跌30\%，那么年金债券在一年内违约的概率是多少？
    ...
    \begin{question}
        ...
        \\一位股权研究公司的金融分析师正在关注一家名为GLOBE Inc的公司。在最近的股东会议上，董事会表示，如果下个季度经济繁荣，公司有70\%的概率支付股息，如果经济波动，公司有40\%的概率支付股息。一位经济预测师预测，经济繁荣的概率为30\%，经济波动的概率为70\%。根据这些信息，经济实际上繁荣的概率是多少，前提是GLOBE Inc支付股息？
        \end{question}
...
\begin{question}
    ...
    \\一家信用卡公司每天评估1000万笔交易进行欺诈检测。已知0.001\%的交易是欺诈的。公司的算法可以识别90\%的欺诈交易，但也会错误地将0.0001\%的合法交易标记为欺诈。如果一笔交易被标记为可疑，那么它实际上是欺诈交易的概率是多少？
\end{question}
