...
\begin{question}
    ...
    一位固定收益投资公司的风险分析师正在分析一张美国国债。这张国债的现金价格为107，在8月15日进行交易结算。票息按年4\%支付，分别在5月15日和11月15日支付。根据美国国债的天数计算惯例Actual/actual，这张国债的报价是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位固定收益投资公司的风险分析师正在分析担保公司债券的声明。以下哪个陈述是正确的？
    \end{question}
...
\begin{question}
    ...
    \end{tabular}
    \end{center}
    一位固定收益投资公司的风险分析师正在分析债券。给定无风险利率为3\%，违约概率为5\%，回收率为45\%，以下哪个债券的预期收益率 exactly equal to 6.5\%?
    \begin{center}
        \begin{tabular}{|c|c|}
        \hline
        债券 & 信用利差（基点） \\
...
\begin{question}
    ...
    \\一位固定收益投资公司的初级分析师正在审查关于高收益债券的声明。以下哪个陈述是正确的？
    \end{question}
    ...
    \begin{choices}
        ...
        原本投资级的债券如果发行公司的财务状况恶化，信用评级下降，就会变成高收益债券，这类债券被称为“堕落天使”。
...
\begin{question}
    ...
    \\一位金融顾问正在向客户解释债券契约。其中一个契约是利息覆盖率最低要求。以下哪个陈述正确地配对了债券契约类型？
    \end{question}
...
\begin{question}
    ...
    \\一位固定收益交易公司的风险分析师正在评估不同的债券契约，确定哪个是肯定条款。以下哪个债券契约是肯定条款？
    \end{question}
...
\begin{question}
    ...
    \\一位财富管理公司的金融顾问正在审查两位客户Tom和Jerry的债券组合的事件风险。Tom认为由于他们的组合中包含高收益债券，事件风险可以忽略不计。Jerry认为由于他们的组合中包含大量不同的债券，事件风险已经完全从他们的组合中消除。以下哪个陈述是基于正确的假设？
    \end{question}
...
\begin{question}
    ...
    \\一位投资银行的信用风险分析师被要求解释违约风险、利差风险和事件风险的主要区别。以下哪个陈述最准确地描述了这些区别？
    \end{question}
    ...
    \begin{choices}
        ...
        违约风险涉及借款人无法履行债务义务的风险，利差风险是因市场流动性变化等因素导致债券利差变动的风险，事件风险是与公司层面事件（如领导层变动、监管问题等）相关，这些事件会影响公司财务状况的风险。
        ...
        违约风险主要由行业特定衰退驱动，利差风险主要由宏观经济政策导致，事件风险仅与影响公司的自然灾害有关。
...
\begin{question}
    ...
    \\一位信托公司的企业信托经理ABC Trust被任命为XYZ银行发行的债券的第三方受托人。以下哪个陈述关于ABC Trust作为债券契约的第三方受托人的角色是正确的？
    \end{question}
    
    \begin{choices}
        \item ABC Trust is paid by XYZ Bank but is obligated to represent the interests of the bondholders.\\
        ABC Trust由XYZ银行支付，但有义务代表债券持有人的利益。
        ...
        ABC Trust应仅在大多数债券持有人明确指示时才行动，无论契约条款如何。
    ...
    \begin{question}
        ...
        \\一位固定收益投资公司的分析师正在比较零息债券和附息债券的同期限债券。相对于同期限的附息债券，零息债券不涉及哪种风险？
        \end{question}
...
\begin{question}
    ...
    \\一位债券投资公司的风险分析师正在评估公司债券契约中受托人的角色。以下哪个陈述关于公司债券契约中受托人的角色是正确的？
    \end{question}
    ...
    \begin{question}
        ...
        \\一位财富管理公司的金融顾问正在与客户讨论投资选项。以下哪个陈述关于高收益债券是正确的？
        \end{question}
...
\begin{question}
    ...
    \\一位固定收益投资公司的风险分析师正在计算两年期平价利率。给定以下即期利率：
    \begin{center}
        \begin{tabular}{|c|c|}
        \hline
        时间 & 即期利率 \\
...
\begin{question}
    ...
    \\一位投资者正在考虑一种年名义利率为7\%的连续复利投资。如果投资是半年复利，等效的年名义利率是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位金融顾问正在分析两张美国国债。第一张债券价格为\$100.35，六个月到期，半年付息一次，票息率为3.5\%。第二张债券价格为\$103.78，一年到期，半年付息一次，票息率为4.5\%。分别计算六个月和一年期的折现因子。
    \end{question}
    ...
    \begin{question}
        ...
        \\一位固定收益投资公司的风险分析师正在计算远期利率。给定三年期零息债券的即期利率为4.2\%，四年期零息债券的即期利率为5.4\%。假设连续复利，三年后的远期利率是多少？
        \end{question}
...
\begin{question}
    ...
    \\一位金融顾问正在向客户解释不同收益率曲线之间的关系。目前，收益率曲线是向上倾斜的。以下哪个陈述准确描述了远期利率收益率曲线、零息收益率曲线和附息债券收益率曲线之间的关系？
    \end{question}
    ...
    \begin{choices}
        ...
        零息收益率曲线在附息债券收益率曲线之上，远期利率收益率曲线在零息收益率曲线之上。
        ...
        远期利率收益率曲线在零息收益率曲线之上，附息债券收益率曲线在远期利率收益率曲线之上。
        ...
        附息债券收益率曲线在远期利率收益率曲线之上，零息收益率曲线在附息债券收益率曲线之上。
        ...
        附息债券收益率曲线在零息收益率曲线之上，远期利率收益率曲线在附息债券收益率曲线之上。
    \end{choices}
...
\begin{question}
    ...
    \\一位金融公司的风险分析师正在分析零息政府债券。三年期零息政府债券的价格为82.54，四年期零息政府债券的价格为76.32。从第三年到第四年的隐含一年期远期利率是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位投资者正在查看利率市场。一年期的连续复利利率为4\%，两年期的连续复利利率为6\%。假设连续复利，从第一年末到第二年末的远期利率是多少？
    \end{question}
    ...
    \begin{question}
        ...
        \begin{center}
            ...
            \end{center}
            \begin{itemize}
            \item 从今天起一年后的一年期远期利率 = 10.56\%
            \item 从今天起两年后的一年期远期利率 = 11.77\%
            \item 从今天起一年后的两年期远期利率 = 12.32\%
            \end{itemize}
            根据债券价格，以下关于远期利率的陈述哪个是正确的？
        \end{question}
...
\begin{question}
    ...
    \\一位金融顾问正在帮助客户计算一张3年期、\$1500面值的债券的现值。该债券的年化利率为4\%，按季度复利。这张债券的现值是多少，四舍五入到最接近的美元？
    \end{question}
...
\begin{question}
    ...
    \\一位固定收益交易公司的风险分析师正在分析利率期限结构。给定两年半期的连续复利即期利率为3.80\%，三年期的连续复利即期利率为4.10\%，交易员需要计算两年半期到三年期的远期利率，以便做出明智的交易决策。计算这个远期利率。
    \end{question}
    ...
    \begin{question}
        ...
        \\一位固定收益交易公司的风险分析师正在分析利率期限结构。给定以下即期利率：
        \begin{center}
        \begin{tabular}{|c|c|c|}
        \hline
        时间 & 即期利率 \\
...
\begin{question}
    ...
    \\一位投资者正在考虑一张8年期的零息债券。给定到期收益率（YTM）为7.25\%，这张债券的面值是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位投资者正在考虑一种10年期的年金产品，年利率为5.5\%，半年付息一次。该年金的面值为100。如果要求的收益率为7\%，这张年金的现值是多少？
    \end{question}
    ...
    \begin{question}
        ...
        \\给定六个月和两年期零息债券的价格分别为97.53和85.70，使用零利率线性插值法（季度复利）计算一年期零息债券的价格是多少？
        \end{question}
...
\begin{question}
    ...
    \\一位固定收益投资公司的风险分析师正在分析零息债券。给定一年期和三年期零息债券的价格分别为93.52和78.63，使用零利率线性插值法（半年度复利）计算两年期零息债券的价格是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位固定收益投资公司的风险分析师正在评估一张三年期零息债券，该债券由公司ABC发行。目前，债券评级为BBB。一年后，ABC预计仍将保持BBB评级，概率为75\%，评级上调至A的概率为15\%，评级下调至BB的概率为10\%。无风险利率为3\%。AAA、BBB和BB评级机构的信用利差分别为60、120和200个基点。所有利率均按年复利计算。估计一年后零息债券的预期价值（面值为100美元）。
    \end{question}
...
\begin{question}
    ...
    \\一位投资银行的初级债券分析师正在分析一张\$2,000面值的公司债券。该债券的年利率为7\%，半年付息一次，还有12次付息剩余。当前市场利率为6\%。结算日和下次付息日之间有120天。这张债券的脏价和净价分别是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位投资者购买了一张面值为\$12,000的美国国债。该债券的年利率为7\%，到期日为2018年9月15日。投资者于2015年6月1日结算购买。上次付息日为2015年3月15日，下次付息日为2015年9月15日。给定债券的到期收益率为5\%，债券的报价价格最接近多少？
    \end{question}
...
\begin{question}
    ...
    \\一位投资公司的金融顾问被要求识别国债市场的套利机会，通过比较各种债券的现金流与组合其他债券的现金流。如果一年期零息债券的价格为USD 97.25，一年期债券支付12\%的年利率，半年付息一次，价格为USD 108.30，那么一年期美国国债支付6\%的年利率，半年付息一次的价格应该是多少？
    \end{question}
...
\begin{question}
    ...
    一位金融机构的债券交易员正在查看三只美国国债的价格，这些国债将于2026年8月30日到期，正好是结算日2025年8月30日的一年之后。这些债券每半年支付一次票息，并且具有相同的票息支付日期。下表显示了这三只债券中两只的价格：
    \begin{center}
    \begin{tabular}{|c|c|}
    \hline
    票面利率 & 价格 \\
...
\begin{question}
    ...
    \\一位投资公司的投资组合经理从债券经销商处获得了两只债券，Bond A和Bond B，它们的到期期限和票面利率相同。经销商告诉经理，Bond A相对于国债市场的利差为20个基点，而Bond B相对于国债市场的利差为60个基点。以下哪个陈述代表了经理可以得出的正确结论？
    \end{question}
    ...
    \begin{choices}
        ...
        为了使Bond B的现金流的现值等于其面值，60个基点应该被添加到具有相似到期期限的国债的到期收益率。
        ...
        利差差异表明，Bond A和Bond B的到期收益率之间存在0.4\%的差异，而不是价格差异。
    \end{choices}
...
\begin{question}
    ...
    \\一位财富管理公司的投资者正在分析一张10年期的债券。该债券的当前价格为\$950.00，每年支付5.5\%的票息。这张债券的到期收益率（YTM）是多少？
    \end{question}
...
\begin{choices}
    ...
    如果两种债券的期限相同且适用相同的即期利率期限结构，收益率较低的债券是更具吸引力的投资。
\end{choices}
...
\begin{question}
    ...
    \\一位保险公司的风险经理正在分析债券组合的利率敏感性，并考虑一张面值为USD 100，三年期，5\%票息的债券。该债券每年支付一次票息，年收益率为7\%，年复利。这张债券的美元久期是多少，美元久期定义为修正久期乘以债券的当前价值？
    \end{question}
...
\begin{question}
    ...
    \\一位投资者持有15年，4\%票息的美国国债（T - 债券）的空头头寸，到期收益率为5\%，面值为\$100。假设折现发生在半年度基础上。这张债券的DV01是多少？
    \end{question}
    ...
    \begin{question}
        ...
        \\一位投资者持有面值为\$100的债券，DV01为0.1035的空头头寸。为了对冲利率风险，投资者使用一张25年，4.5\%票息的美国国债（T - 债券），到期收益率为4.5\%，DV01为0.1425。投资者应该采取以下哪个行动？
        \end{question}
...
\begin{question}
    ...
    一位金融机构的风险分析师被要求计算当利率为6\%时的有效凸性。给定以下利率和相应资产价格的表格：
    \begin{center}
    \begin{tabular}{|c|c|}
    \hline
    利率 & 资产价格 \\
    ...
    \begin{question}
        ...
        \\一位金融顾问正在向客户解释可赎回债券。以下哪个陈述关于可赎回债券是最准确的？
        \end{question}
        ...
        \begin{choices}
            ...
            通常要求发行人支付高于面值的溢价来赎回债券，并且随着债券临近到期，该溢价金额通常会下降。
...
\begin{question}
    ...
    \\一位投资公司的风险分析师正在评估可回售债券的特性。以下哪个陈述关于可回售债券是正确的？
    \end{question}
    ...
    \begin{question}
        ...
        \\一位固定收益交易公司的初级交易员正在管理一个包含两只债券的组合，Bond X和Bond Y。两只债券的修正久期均为4年，面值均为USD 1200。Bond X是一张零息债券，当前价格为USD 1050，而Bond Y每年支付两次票息，按面值定价。如果无风险收益率曲线向上移动2个基点，你预计Bond X和Bond Y的市场价格会发生什么变化？
        \end{question}
        
        \begin{choices}
            \item Both bond prices will move up, and Bond Y will gain more than Bond X.\\
            两只债券的价格都会上涨，且Bond Y的涨幅大于Bond X。
            ...
            两只债券的价格都会下跌，且Bond Y的跌幅大于Bond X。
        \end{choices}
...
\begin{question}
    ...
    \\一位固定收益投资公司的初级风险分析师被要求评估债券组合的利率风险。分析师决定使用DV01作为衡量利率风险的指标。以下哪个假设在使用DV01时是正确的？
    \end{question}
...
\begin{question}
    ...
    \\一位固定收益投资公司的风险分析师被要求计算收益率增加15个基点对债券组合价值的影响。债券组合的详细信息如下：
    \begin{center}
    \begin{tabular}{|c|c|c|}
    \hline
    债券 & 价值（美元） & 修正久期\\
...
\begin{question}
    ...
    \\一位对冲基金的风险分析师正在调整基金的利率风险敞口。分析师已经研究了市场趋势，并预计利率会有显著变化。为了获得负久期的利率敞口，分析师计划投资于固定收益证券。分析师应该采取以下哪个头寸？
    \end{question}
    
    \begin{choices}
        \item An interest rate swap paying LIBOR plus a margin and receiving fixed\\
        支付LIBOR加上利差并收取固定利率的利率互换
...
\begin{question}
    ...
    一位债券投资公司的风险分析师正在分析一只6年期、票面利率9\%的债券（每年付息），定价为年收益率11\%。该债券的面值为\$120，价格为\$108.6527。分析师已计算出以下数值：
    \begin{center}
    \begin{tabular}{|c|c|}
    \hline
    指标 & 数值 \\
    ...
    \begin{choices}
        ...
        风险分析师应该使用修正久期和修正凸性，估计的资本损失金额为\$2.2103。
        ...
        风险分析师应该使用麦考利久期和修正凸性，估计的资本损失金额为\$2.2204。
    \end{choices}
...
\begin{question}
    ...
    \\一位固定收益分析师在一家金融机构研究无期权债券的凸性对债券价格变化幅度的影响。对于无期权债券，凸性调整对债券价格变化幅度（绝对值）在收益率下降和收益率上升时分别有什么影响？
    \end{question}
...
\begin{question}
    ...
    \\ABC公司发行的债券目前可以按面值赎回，且交易价格接近面值。这些债券还有7年到期，票面利率为7\%。ABC债券的年收益率比7年期美国国债高出150个基点，且美国国债的即期收益率曲线呈正常上升形状。如果可比债券的收益率大幅下降，ABC债券最有可能表现出：
    \end{question}
...
\begin{question}
    ...
    \\一位金融顾问正在与客户讨论债券投资策略。他们正在评估不同的债券特征和投资组合概念。以下哪个陈述是正确的？
    \end{question}
    ...
    \begin{choices}
        ...
        投资组合的凸性是各组成部分久期的加权平均值，但投资组合的久期不是各组成部分凸性的加权平均值。
    \end{choices}
...
\begin{question}
    ...
    \\一位投资公司的固定收益分析师正在评估一只7年期、4\%票息的债券，面值为\$100。该债券目前交易价格为\$95.23。当利率下降25个基点时，该债券价格上升至\$96.88，当利率上升25个基点时，该债券价格下降至\$93.55。该债券的有效久期最接近多少？
    \end{question}
...
\begin{question}
    ...
    \\一位投资公司的风险分析师正在使用估值模型评估债券组合。模型估计当前债券组合的价值为USD 130.526百万美元。利率期限结构是平坦的。分析师进一步估计，如果所有利率下降40个基点，债券组合价值将增加到USD 133.879百万美元，如果所有利率上升40个基点，债券组合价值将减少到USD 127.173百万美元。基于这些估计，债券组合的有效久期最接近多少？
    \end{question}
...
\begin{question}
    ...
    一位金融机构的风险分析师正在使用公司的估值系统评估投资级可赎回债券的价格敏感性。当前利率环境在6\%的水平上保持平坦。下表显示了在不同利率水平下，可赎回债券和嵌入看涨期权的价值（以美元计，每美元120面值）：
    \begin{center}
    \begin{tabular}{|c|c|c|}
    \hline
    利率水平 & 可赎回债券 & 看涨期权 \\
...
\begin{question}
    ...
    \\一位投资公司的投资组合经理正在考虑两种债券投资策略：杠铃策略和子弹策略。公司的经济研究团队预测未来收益率曲线将发生较大的平行移动。根据这一预测，这两种策略的表现如何比较？
    \end{question}
    ...
    \begin{question}
        ...
        \\        一位固定收益投资组合经理目前持有一个子弹式6年期美国国债头寸，面值为5000万美元。经理旨在创建一个成本匹配的杠铃式投资组合，通过购买3年期国债和12年期国债的组合，该组合将与6年期美国国债头寸具有相同的久期。三种美国国债的数据如下所示：
        \begin{center}
        \begin{tabular}{|c|c|c|}
        \hline
        到期期限 & 价格 & 久期 \\
...
\begin{question}
    ...
    \begin{choices}
        ...
        PCA仅通过分析月度利率数据确定利率变化因素，所有因素都有清晰直接的经济解释。
        ...
        通过求解一组联立方程，任何\(m\)个利率的变化都可以表示为\(m\)个因素的线性组合。
        ...
        PCA因素之间是相互关联的，最后几个因素通常解释了大部分观察到的每日利率变动。
    \end{choices}
...
\begin{question}
    ...
    \end{tabular}
    \end{center}
    一位固定收益投资公司的风险分析师正在评估一只4年期债券，面值为100，年票面利率为3\%。远期利率如下表所示。投资者每年获得60个基点的利差。假设远期利率得以实现且利差保持不变，计算第一年的持有滚动收益。
    \begin{center}
    \begin{tabular}{|c|c|}
    \hline
    期限（年） & 远期利率（\%） \\
...
\begin{question}
    ...
    \\一位投资公司的固定收益分析师正在分解一只债券在过去6个月内的损益（P\&L）。该债券的票面利率为3\%，每半年付息一次，在6个月期初时距离到期日还有正好2年。关于该债券和市场利率（半年复利）的相关信息如下所示：
    \begin{center}
    \begin{tabular}{|c|c|c|}
    \hline
    & 期初 & 期末 \\
    \hline
    债券价格（新加坡元） & 101.25 & 102.36 \\
    \hline
    债券利差（基点） & 40 & 30 \\
    \hline
    \end{tabular}
    ...
    \end{tabular}
    \end{center}
    分析师已计算出该债券的持有滚动收益，在该计算所采用的远期利率假设下，债券的期末价值为新加坡元101.71。根据这些信息，债券损益中可归因于6个月期间利率变化的组成部分是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位固定收益投资公司的风险分析师正在使用关键利率变动来评估即期利率变化对债券价格的影响。分析师注意到12年期即期利率增加了15个基点，而这一冲击对22年期即期利率线性下降到0。这一冲击对16年期即期利率的影响是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位固定收益投资公司的风险分析师正在使用关键利率暴露分析关键利率为3年、6年、8年和25年的债券价格对关键利率变动的敏感性。以下哪个假设在使用这些关键利率时是不正确的？
    \end{question}
...
\begin{question}
    ...
    \\一位投资经理正在使用三种对冲证券对冲投资组合：3年期、7年期和12年期债券。到期期限对应于3年、7年和12年的三个关键利率。债券的关键利率'01（KR01）如下表所示，它们按每\$100面值报告。标的投资组合的KR01也已提供（按面值报告）。
    \begin{center}
    \begin{tabular}{|c|c|c|c|}
    \hline
    & \multicolumn{3}{c|}{关键利率01（每\$100面值）} \\
    \hline
    对冲证券 & 3年期 & 7年期 & 12年期 \\
    \hline
    3年期债券 & 0.015 & & \\
    ...
    \begin{tabular}{|c|c|c|c|}
    \hline
    & \multicolumn{3}{c|}{关键利率01（\$）} \\
    \hline
    & 3年期 & 7年期 & 12年期 \\
    \hline
    标的投资组合 & 30.0 & 80.0 & 120.0 \\
    \hline
    \end{tabular}
    \end{center}
    所需的三年期（3年期）对冲债券的面值是多少？
    \end{question}
...
\begin{question}
    ...
    \\一位金融公司的投资分析师正在计算一只债券的远期桶O1。该债券每年支付6\%的票息，面值为120,000元，还有4年到期。分析师观察到远期利率曲线在4\%水平上保持平坦（所有远期利率均按一年期计算），并使用两个远期桶：0 - 3年和3 - 4年。假设利率上升，3 - 4年远期桶的远期桶O1是多少？
    \end{question}
