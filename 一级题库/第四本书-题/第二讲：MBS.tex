...
\begin{question}
    ...
    Bennett Bank 向借款人发放了100,000美元的30年期抵押贷款，年利率为5\%，每月等额还款。如果该抵押贷款要求在前5年只支付利息，之后转为自偿性抵押贷款，那么在第61个月，每月还款中用于本金的部分是多少？
    \end{question}
    ...
    \begin{explanation}
            ...
            \begin{question}
                ...
                考虑一个30年期的抵押贷款，初始利率为5\%，每月复利，本金为100,000美元。在前5年，利率为5\%，之后利率降至3.5\%。假设再融资过程保持本金和期限不变，每月还款额减少了多少？
                \end{question}
    ...
    \begin{question}
        ...
        \\一位固定收益投资组合经理购买了一只 seasoned 5.5\% 的机构抵押贷款支持证券，加权平均贷款年龄为60个月。目前贷款余额为2000万美元，假设条件提前还款率为每年0.4\%。以下哪个选项最接近本月预计的提前还款本金？
        \end{question}
...
\begin{question}
    ...
    \\一位绿色能源投资基金的投资组合经理正在评估一个可持续基础设施债券池。该债券池包含三只不同的绿色债券，为可再生能源项目融资。三只债券的信息如下所示：
    ...
    \hline
     & 票面利率 & 到期期限 & 本金（美元） \\
    \hline
    绿色债券1 & 4.5\% & 120 months & 2,500,000 \\
    \hline
    绿色债券2 & 5.5\% & 180 months & 3,500,000 \\
    \hline
    绿色债券3 & 6.5\% & 240 months & 4,000,000 \\
    \hline
    \end{tabular}
    \end{center}
    
    该绿色债券池的加权平均票面利率的正确计算是什么？
    \end{question}
    ...
    \begin{question}
        ...
        \\你正在分析一个绿色抵押贷款支持证券（Green MBS）组合，其中 underlying mortgages 都是与节能房屋相关的。该组合总价值为5亿美元，具有不同的提前还款特征。以下哪个场景可能降低该绿色MBS组合的提前还款风险？
    \end{question}
        ...
        \begin{choices}
            ...
            节能房屋的周转率很高，因为 homeowners 经常升级到更节能的新房产。
            ...
            该组合中的大多数抵押贷款已经进入最后几年，剩余余额相对较小，能源效率评级较高。
            ...
            借款人持有利率为3\%的抵押贷款（包括绿色抵押贷款折扣），而当前市场利率已上升至6\%，用于类似的绿色抵押贷款。
        \end{choices}
        ...
        \checklist{影响MBS提前还款风险的关键因素。（需要知道月还款额公式）}
            ...
            \begin{question}
                ...
                如果一个按揭贷款池月初余额为1050万美元，计划支付54,800美元，月末余额为980万美元，本月提前还款率是多少？
            \end{question}
    ...
    \begin{question}
        ...
        \\一位投资者正在评估抵押贷款支持证券（MBS）的风险，这些MBS由一组保险抵押贷款支持。这些抵押贷款具有提前还款风险，允许借款人在利率下降时提前还款。从投资者的角度来看，持有MBS类似于持有一个不可提前还款的抵押贷款池的长期头寸，与以下哪个选项类似？
        \end{question}
        ...
        \begin{question}
            ...
            \\一位 homeowner 持有30年、4.5\%固定利率的抵押贷款，余额为30万美元。抵押贷款利率一直在下降。如果现有的抵押贷款被再融资为新的30年、3.5\%固定利率的抵押贷款，以下哪个选项最接近 homeowner 每月节省的抵押贷款金额？
            \end{question}
            ...
            \begin{choices}
                ...
                房贷利率总是浮动的，允许借款人在利率下降时提前还款，降低他们的利息。
...
\begin{question}
    ...
    \\一位资产管理部门的风险分析师被要求评估不同类型的贷款及其相关的风险，以评估客户投资组合。根据贷款类型和风险的描述，以下哪个描述是正确的？
\end{question}
...
\begin{choices}
    ...
    非标准贷款通常由三大机构以外的私人机构发行，可能具有更高的风险。
\end{choices}
...
\begin{question}
    ...
    \\一位银行贷款经理正在审查客户的抵押贷款还款计划。客户在本月底的未偿还本金余额为150,000元。本月应还款为10,000元，但客户实际还款为15,000元。计算本月的单月提前还款率（SMM）。
\end{question}
...
\begin{question}
    ...
    PSA（公共证券协会）提前还款基准假设抵押贷款池的每月提前还款率随着其年龄或季节变化而增加。对于30年期的抵押贷款，100\% PSA（或简称为100 PSA）假设以下递增的CPR（条件提前还款率）：CPR在第一个月为0.2\%，每月增加0.2\%，直到第30个月。例如，第14个月的CPR为14(0.2\%) = 2.8\%。从第30个月到第360个月，CPR为6\%。根据这些信息，以下哪个陈述是正确的？
\end{question}

\begin{choices}
    \item 100\% PSA assumes a CPR of 6\% for all months.\\
    100\% PSA假设所有月份的CPR均为6\%。
    \item 50\% PSA refers to half of the CPR specified by 100\% PSA, while 200\% PSA refers to twice the CPR specified by 100\% PSA.\\
    50\% PSA指的是100\% PSA指定的CPR的一半，而200\% PSA指的是100\% PSA指定的CPR的两倍。
...
\begin{question}
    ...
    Tom是一位经验丰富的固定收益交易员，正在考虑通过管理其投资组合来采用两种不同的融资策略：回购协议（repo）和美元滚动交易。投资组合包括一个面值为1亿美元的30年期FNMA池，票面利率为4.5\%。他想了解这些策略的关键区别。以下哪个陈述是正确的？
\end{question}
    ...
    \begin{choices}
        ...
        在回购交易中，Tom会同意在未来以相同价格买回他最初卖出的相同证券。在美元滚动交易中，他可能会买回类似但不完全相同的证券。
        ...
        当Tom评估美元滚动交易的价值时，成本应包括在融资期间出售证券所获得的利息收入。
        ...
        在美元滚动交易中，Tom应该收到在融资期间出售的抵押贷款池的利息和本金还款。
    \end{choices}
...
\begin{question}
    ...
    一位初级交易员正在分析美元滚动交易和传统回购协议之间的差异，以优化公司的交易策略。美元滚动交易和传统回购协议之间的一个关键区别是什么？
\end{question}
...
\begin{question}
    ...
    一位初级固定收益投资公司的抵押贷款分析师正在评估抵押贷款支持证券的交易策略，特别关注理解TBA（To-Be-Announced）交易模式，以优化客户投资组合。以下哪个描述是关于TBA交易模式的正确描述？
\end{question}
...
\begin{choices}
    ...
    在特定资产池交易模式下，投资者只有在交易完成后才能了解资产池的具体特征，增加了交易的不确定性。
    ...
    在TBA交易模式下，交易双方在交易完成时都知道具体的资产池，减少了交易的不确定性。
    ...
    在TBA交易模式下，合约要求买方选择最便宜的可交割资产池，满足合约要求。
    ...
    特定资产池交易模式在交易前就明确了资产池的所有具体特征，因此提供了比TBA模式更高的交易灵活性和流动性。
\end{choices}
...
\begin{question}
    ...
    一位投资银行的金融顾问正在分析抵押贷款支持证券（MBS）交易中的美元滚动交易的机制，以提供给客户洞察。根据美元滚动交易的详细描述，以下哪个描述是最准确的描述？
\end{question}
...
\begin{choices}
    ...
    在美元滚动交易中，投资者必须在连续两个月内购买完全相同的证券，以确保一致性和可预测性。
    ...
    在美元滚动交易中，第二个月的回购价格通常包括应计利息，以反映资金的时间价值和机会成本。
    ...
    在美元滚动交易中，下个月购买的证券可能与第一个月不同，且在回购价格上没有利息的增加，这导致交易的一方在一个月内失去利息收入，而另一方则获得相应的利息收益。
    ...
    美元滚动交易与标准的回购协议在所有方面都是相同的，适用于所有类型的MBS交易，不影响投资者的现金流。
\end{choices}
...
\begin{question}
    ...
    假设一个面值为200万美元、票面利率为4\%的抵押贷款池在8月份以104.00的价格出售，并在9月份以103.25的价格回购。104和103.25是面值的百分比。每月还款日期为每月的15日（假设每月30天）。第一个月销售所得资金将获得一个月的利息，利率为0.15\%。假设放弃的票息和本金支付为面值的0.6\%。计算这个美元滚动交易的价值。
\end{question}
...
\begin{question}
    ...
    一位投资公司的金融分析师正在比较本金只支付（PO）证券和利息只支付（IO）证券的特征，以提供有价值的洞察，帮助投资决策。以下哪个陈述是正确的？
\end{question}

\begin{choices}
    \item PO securities have larger cash flows at the beginning, which decrease over time.\\
    PO证券在初期现金流较大，随着时间的推移而逐渐减少。
    ...
    利率和提前还款率的不确定性通常会导致IO证券的价值降低，而PO证券的价值则可能因本金回收的加速而增加，从而使其在不确定性中更具吸引力。
\end{choices}
...
\begin{question}
    ...
    一位金融分析师正在评估本金只支付（PO）证券和利息只支付（IO）证券的特征，以确定它们各自的风险和回报。以下哪个陈述是正确的？
\end{question}
...
\begin{question}
    ...
    一位金融分析师正在评估To Be Announced（TBA）市场的结构，这是抵押贷款支持证券（MBS）市场的一个子集。以下哪个陈述最准确地描述了TBA市场的结构？
\end{question}

\begin{choices}
    \item TBAs are comprised of highly diverse securities thereby reducing the risk to investors.\\
    TBAs由高度多样化的证券组成，从而降低投资者的风险。
    ...
    TBA市场本质上是一个远期市场，买卖双方同意在未来交换一组证券以换取现金。
    ...
    TBA市场实际上有两个独立的市场，一个用于固定利率机构池，另一个用于传统可调利率抵押贷款池。
\end{choices}
...
\begin{question}
    ...
    一位MBS投资者正在评估两种融资方法，以购买最近购买的MBS池。一种方法涉及进入回购协议（repo）并立即出售池子。另一种方法涉及购买美元滚动。购买滚动而不是进入回购协议的一个优势是滚动买家：
\end{question}
...
\begin{question}
    ...
    Emma，一位全球投资银行的结构化产品分析师，正在评估一个面值为8亿美元的新型住宅抵押贷款支持证券（RMBS）。她的团队需要评估抵押贷款池的提前还款风险特征。以下哪个陈述关于MBS分析是正确的？
    \end{question}
    ...
    \begin{choices}
        ...
        对于吉利美MBS估值，提前还款风险和信用风险建模应该被优先考虑，因为它们在价格决定中具有同等重要性。
        ...
        抵押贷款池的加权平均FICO分数主要反映了证券化过程中贷款机构的信用质量。
        ...
        当单月死亡率（SMM）上升时，IO层价值上升，因为利息支付增加，而PO层价值下降，因为本金还款加速。
        ...
        在提前还款建模中，FICO分数和LTV比率是违约概率估计的关键输入，而贷款年限有助于预测自愿提前还款模式。
    \end{choices}
    ...
    \begin{question}
        ...
        一位量化对冲基金的组合经理正在评估一个面值为5亿美元的机构MBS。她需要识别可能导致提前还款风险增加并影响组合现金流的因素。以下哪个场景最可能导致提前还款率上升？
    \end{question}
        ...
        \begin{choices}
            ...
            美联储实施宽松政策，导致30年期抵押贷款利率下降125个基点。
        \end{choices}
        ...
        \begin{question}
            ...
            在抵押贷款支持证券（MBS）的背景下，提前还款行为建模涉及复杂的数学关系，不仅取决于利率，还取决于各种因素。一个常用的提前还款率模型是：
            \[
            \text{Prepayment Rate} = \frac{1}{a + b \cdot e^{-c \cdot T}}
            \]
            其中\( a, b, c \)是根据经验数据确定的参数，\( T \)是时间。提前还款率随着利率下降而增加，但最终趋于稳定。请解释为什么在利率下降初期提前还款率会增加，但最终趋于稳定。
        \end{question}
        ...
        \begin{choices}
            ...
            在利率下降初期，借款人倾向于利用更低的利率重新融资，从而增加提前还款率，但随着时间的推移，大多数符合条件的借款人已经重新融资，导致提前还款率趋于稳定。
            ...
            在利率下降初期，借款人没有提前还款的动机，因为新贷款利率可能不会显著低于他们当前的贷款利率，因此提前还款率不会增加。
            ...
            提前还款率完全由市场情绪驱动，与利率变化无关，这意味着即使利率下降，借款人也可能出于其他原因选择提前还款。
            ...
            提前还款率永远不会稳定；相反，它会随着利率下降而继续增加，因为借款人总是倾向于以较低的利率重新融资。
        \end{choices}
        ...
        \begin{question}
            ...
            一位抵押贷款投资公司的风险分析师正在研究各种方法，以解决抵押贷款支持证券中的提前还款路径依赖问题。以下哪个方法通常用于避免与提前还款路径依赖相关的问题？
        \end{question}
        ...
        \begin{question}
            ...
            一位金融公司的抵押贷款分析师正在研究影响抵押贷款支持证券（MBS）提前还款行为的各种因素。以下哪个陈述正确描述了提前还款行为的一个特征？
        \end{question}
        ...
        \begin{choices}
            ...
            再融资的可能性与市场利率的上升成正比，与借款人信用质量的提高成正比。
...
\begin{question}
    ...
    一位投资银行的固定收益分析师正在研究MBS估值的Option-Adjusted Spread（OAS）方法。以下哪个陈述最可能误解了OAS估值程序的特征？
\end{question}
...
\begin{choices}
    ...
    OAS估值程序包括对OAS进行初始估计，然后使用美国国债收益率作为贴现率进行蒙特卡洛模拟。
    ...
    OAS表示固定收益证券预期收益率超过无风险收益率的差额，用于衡量MBS的相对估值。
    ...
    OAS的均值复归特性意味着OAS估计值需要反复调整，直到模拟价格等于市场价格。
    ...
    OAS估值方法的一个局限性是，OAS本身假设利差在一段时间内保持不变，但实际上OAS会随时间变化。
\end{choices}
...
\begin{question}
    ...
    \begin{center}
        ...
        \end{tabular}
        \end{center}
        Emily，一位固定收益分析师，最近完成了一项CMO分层的蒙特卡洛模拟分析。她的分析包括三个等权重的路径，每个路径的现值使用不同的利差计算。如果CMO分层的实际市场价格为70.00，那么期权调整利差（OAS）是多少？
        \begin{center}
            \begin{tabular}{|c|c|c|c|}
            \hline
            \textbf{路径} & \textbf{55基点时的现值} & \textbf{65基点时的现值} & \textbf{75基点时的现值} \\
            \hline
            1 & 72 & 70 & 68 \\
            2 & 74 & 72 & 70 \\
            3 & 70 & 68 & 66 \\
...
\begin{question}
    ...
    一位量化分析师正在改进他们的MBS估值模型。在他们的研究中，他们发现传统的估值方法可能无法完全捕捉这些证券的复杂性。在分析不同的方法论时，他们特别关注路径依赖特征。以下关于路径依赖和估值方法的发现哪个是正确的？
\end{question}
...
\begin{choices}
    ...
    燃尽效应表明，当再融资利率显著下降时，提前还款率往往不会大幅上升。这是因为在之前的低利率周期中，倾向于再融资的借款人已经完成了再融资。剩余的借款人对利率变化的敏感度较低，即使利率进一步下降，也不太可能进行再融资。
    ...
    路径依赖主要影响MBS估值中的短期定价调整，对长期价值影响最小。
    ...
    蒙特卡洛模拟的主要优势在于其计算速度，而不是其捕捉路径依赖特征的能力。实际上，为了准确模拟路径依赖性，蒙特卡洛模拟往往需要大量的计算时间。
\end{choices}
...
\begin{question}
    ...
    一位固定收益投资公司的资深分析师被任命为培训新团队成员关于MBS估值方法。在Option-Adjusted Spread（OAS）分析的介绍中，团队成员提出了关于方法局限性的问题。分析师回顾了他们的笔记，需要确定哪个关于OAS特征的陈述需要纠正。以下哪个陈述最可能误解了OAS的特征？
\end{question}

\begin{choices}
    \item OAS is based on Monte Carlo simulation results, which may inherently contain model risk.\\
    OAS是基于蒙特卡洛模拟结果得出的，这本身就包含模型风险。
