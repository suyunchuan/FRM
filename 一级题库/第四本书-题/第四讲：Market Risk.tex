...
\checklist{VaR的计算。（需要知道delta的作用）} 
    ...
    \begin{choices}
        \item Bank X will report a higher VaR.  
        \item Bank Y will report a higher VaR.  
        \item Both banks will report the same VaR.  
...
\begin{choices}
    ...
    \item The Delta-Normal method performs excellently in VaR precision over short windows, while the Historical Simulation method
    has advantages in handling time-varying risks and unusual events.
\end{choices}
