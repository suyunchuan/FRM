...
\end{itemize}
    ...
    Robert Liu
    \\收集了四个新兴市场的大量每日市场收益率数据集。他担心数据中的非正态偏度，正在考虑非参数估计方法。Liu与同事Jennifer Zhang讨论了该程序。在他们的讨论中，Zhang发表了以下陈述：
    \begin{itemize}
