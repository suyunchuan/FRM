...
\newcommand{\bookonecontents}{%
    \section*{Market Risk Measurement and Management 目录}
    \@starttoc{book1}%
}

\newcommand{\booktwocontents}{%
    \section*{Credit Risk Measurement and Management 目录}
    \@starttoc{book2}%
}

\newcommand{\bookthreecontents}{%
    \section*{Operational Risk and Resilience 目录}
    \@starttoc{book3}%
}

\newcommand{\bookfourcontents}{%
    \section*{Liquidity and Treasury Risk Measurement and Management 目录}
    \@starttoc{book4}%
}

\newcommand{\bookfivecontents}{%
    \section*{Risk Management and Investment Management 目录}
    \@starttoc{book5}%
}

\newcommand{\booksixcontents}{%
...
\newcommand{\checklist}[3]{%
    ...
    \textbf{科目:} \ifthenelse{\equal{#3}{1}}{Market Risk Measurement and Management}{\ifthenelse{\equal{#3}{2}}{Credit Risk Measurement and Management}{\ifthenelse{\equal{#3}{3}}{Operational Risk and Resilience}{\ifthenelse{\equal{#3}{4}}{Liquidity and Treasury Risk Measurement and Management}{\ifthenelse{\equal{#3}{5}}{Risk Management and Investment Management}{综合}}}}}\par
    % 根据不同的 BOOK 添加到相应的目录
    ...
    \ifthenelse{\equal{#3}{5}}{\addcontentsline{book5}{subsection}{题号\thequestion 考察: #1 \tocstar{#2}}}{}
    \ifthenelse{\equal{#3}{6}}{\addcontentsline{book6}{subsection}{题号\thequestion 考察: #1 \tocstar{#2}}}{}
}
% \let\oldtextbf\textbf
% % 重定义 \textbf 命令，使其带有颜色
