...
\begin{choices}
    \item a) A -> 25 -> B -> 60 -> C (new total notional = 110)
    \item b) A -> 30 -> B -> 45 -> C (new total notional = 150)
    \item c) B -> 35 -> C -> 30 -> A (new total notional = 65)
    \item d) B -> 25 -> C -> 10 -> A (new total notional = 70)
\end{choices}
